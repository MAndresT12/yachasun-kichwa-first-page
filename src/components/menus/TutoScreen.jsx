      ...
      <ScrollView style={styles.scrollView}>
        ...
        <CardDefault title="La aplicación y Humu:" >
          <Text style={styles.cardContentCenter}>
            Yachasun Kichwa es una aplicación para que puedas aprender Kichwa. Está dirigida a niños y niñas como tú.
            Queremos que juegues mientras aprendes sobre el Kichwa. La aplicación está dividida en dos secciones: básica e
            intermedia. Podrás elegir entre ambas secciones, pero debes comenzar por la sección básica si recién estás empezando.
            Cada sección tiene varios módulos y cada módulo tiene varios niveles. Al final de cada módulo
            tendrás la oportunidad de jugar varios juegos donde demuestres tus grandes habilidades y además tendrás
        ...
        <CardDefault title="Botones:" >
          ...
          <Text style={styles.cardContentCenter}>
            ...
            (amarillo), juego (verde) o lección (rojo).
          </Text>
        ...
        <CardDefault title="Trofeos e insignias:" >
          <Text style={styles.cardContentCenter}>
            Cuando acabes tu primera lección te darás cuenta de que desbloquearás más niveles e insignias como trofeos. Puedes
            aplastar en estas insignias para ver una pequeña descripción. Cada lección desbloqueará una insignia. Es un
            trofeo bien merecido una vez que lo hayas logrado. ¡Colecciona todas las insignias!
          </Text>
          <ImageContainer path={require('../../../assets/icons/insignia.png')} style={localStyles.iconContainerTrophies} />
          <Text style={styles.cardContentCenter}>
            El anillo de progreso muestra cuántas insignias has completado y cuánto de un módulo has terminado.
          ...
          <Text style={styles.cardContentCenter}>
            En la sección de progreso en los botones de abajo (botón estrella) podrás ver el museo de insignias y admirar
            tus logros.
          </Text>
        ...
        <CardDefault title="Cartas:" >
          <Text style={styles.cardContentCenter}>
            Las cartas aparecen mucho en Yachasun Kichwa. Puedes presionar en ellas para darles la vuelta y aprender más.
            También en ocasiones las cartas no se darán la vuelta, sino que mostrarán una nueva ventana con muchas más cosas
            para aprender.
          </Text>
          ...
          <Text style={styles.cardContentCenter}>
            ...
            es deslizar a Humu hacia la derecha para que puedas ver una segunda carta con más información.
          </Text>
        ...
        <CardDefault title="Acordión y Chat:" >
          <Text style={styles.cardContentCenter}>
            Te encontrarás casi siempre con un acordeón al final de cada nivel. Este acordeón te permitirá ver curiosidades
        ...
        <CardDefault title="Tablas:" >
          <Text style={styles.cardContentCenter}>
            Las tablas serán muy usadas en tu aventura. Muchas de estas tablas tienen pestañas que revelan otra tabla con información.
          ...
          <Text style={styles.cardContentCenter}>
            ...
            con la tabla principal que ves a simple vista. No te preocupes; en cada nivel, Humu te dirá si una tabla puede
            ser presionada.
          </Text>
        ...
        <CardDefault title="Carruseles:" >
          ...
          <Text style={styles.cardContentCenter}>
            En algunas ocasiones te encontrarás con un carrusel dentro de otro carrusel. No te preocupes, simplemente desliza de izquierda
            a derecha de la misma forma. Estos dobles carruseles te darán mucha más información que los carruseles normales.
          </Text>
