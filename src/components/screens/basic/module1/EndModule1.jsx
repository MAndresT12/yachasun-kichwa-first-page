...
const EndModule1 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('EvaluationBasicModule1'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado el Módulo 1. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
                            ...
                            <ButtonDefault
                                label="Siguiente"
                                onPress={() => {
                                    navigation.navigate('GreetingsPart1');
                                }}
                            />
                        </>
                    ) : (
