...
const EndModule6 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('EvaluationBasicModule6'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado el Módulo 6. 
                                Parece que este es el fin de nuestra aventura básica. 
                                Te extrañaré, pero no te preocupes, aún hay mucho por aprender.
                                ¡Sigue con tu aprendizaje con el nivel intermedio!
                            </Text>
                ...
                >
                    <View style={localStyles.modalContainer}>
                        <View style={localStyles.modalContent}>
                            ...
                            <Text style={localStyles.modalMessage}>Has desbloqueado este trofeo por completar exitosamente el Módulo 6.</Text>
