...
const EndModule2 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('EvaluationBasicModule2'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado el Módulo 2. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
                            ...
                            <ButtonDefault
                                label="Siguiente"
                                onPress={() => {
                                    navigation.navigate('FamilyPart2');
                                }}
                            />
                        </>
                    ) : (
