...
const EndModule5 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('EvaluationBasicModule5'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado el Módulo 5. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
