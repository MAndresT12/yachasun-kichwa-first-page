...
import TrophyCard from '../../ui/cards/TrophyCard'; // Importar TrophyCard
...
const EvaluationScreen1 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('Game3'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado esta parte del Módulo 3. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
                            ...
                            <ButtonDefault
                                label="Siguiente"
                                onPress={() => {
                                    navigation.navigate('IntroModuloI4');
                                }}
                            />
                        </>
                    ) : (
                ...
                >
                    <View style={localStyles.modalContainer}>
                        <View style={localStyles.modalContent}>
                            ...
                            <Text style={localStyles.modalMessage}>Has desbloqueado este trofeo por completar exitosamente el Módulo 3.</Text>
