...
const EvaluationScreen1 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('Game2'); // Reintentar evaluación
    };
                ...
                >
                    <View style={localStyles.modalContainer}>
                        <View style={localStyles.modalContent}>
                            ...
                            <Text style={localStyles.modalMessage}>Has desbloqueado este trofeo por completar exitosamente el Módulo 2.</Text>
