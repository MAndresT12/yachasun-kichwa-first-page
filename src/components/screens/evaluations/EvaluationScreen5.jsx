...
const EvaluationScreen1 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('Game5'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado esta parte del Módulo 5. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
                ...
                >
                    <View style={localStyles.modalContainer}>
                        <View style={localStyles.modalContent}>
                            ...
                            <Text style={localStyles.modalMessage}>Has desbloqueado este trofeo por completar exitosamente el Módulo 5.</Text>
