...
const EvaluationScreen1 = ({ route }) => {
    ...
    const handleRetry = () => {
        navigation.navigate('Game4'); // Reintentar evaluación
    };
                    ...
                    {score >= 4 ? (
                        <>
                            <Text style={localStyles.motivationalText}>
                                ¡Genial! Lo has hecho increíble, has completado esta parte del Módulo 4. ¡Sigue explorando y aprendiendo, estoy muy orgulloso de ti!
                            </Text>
                            ...
                            <ButtonDefault
                                label="Siguiente"
                                onPress={() => {
                                    navigation.navigate('IntroModuloI5');
                                }}
                            />
                        </>
                    ) : (
